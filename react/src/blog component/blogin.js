...
function Blogin() {
    ...
    function publish(e){
        ...
        const blog={heading,content,time}
  ...
  <div className="mb-3 mt-3 m-4" >
    ...
    <input type="text" className="form-control" id="n" placeholder="Enter name" name="heading" value={heading} style={{width:"40%",height:""}}  onChange={(e) => setHeading(e.target.value)}/>
  </div>
  <div className="mb-3 mt-3 m-4" >
    <label  className="form-label">content:</label>
    <input type="text" className="form-control" id="n" name="content" value={content} style={{height:"300px"}}  onChange={(e) => setContent(e.target.value)} />
  </div>
